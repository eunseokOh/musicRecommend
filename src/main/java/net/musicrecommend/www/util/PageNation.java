...
public class PageNation implements Serializable {
	...
	public PageNation(long pg, long page_size, long block_size, long total_article_count) {
		this.pg = pg;
		this.page_size = page_size;
		this.block_size = block_size;
		this.total_article_count = total_article_count;
	...
	public PageNation(long pg, long block_size, long total_article_count) {
		this.page_size = 10;
	...
	public PageNation(long pg, long total_article_count) {
		this.page_size = 10;
		this.block_size = 10;
	...
	private void setPageNation() {
		...
		total_page_count = (long) (Math.ceil((double) total_article_count / page_size));
	...
	public String toString() {
		return "PageNation [pg=" + pg + ", page_size=" + page_size + ", block_size=" + block_size
				+ ", total_article_count=" + total_article_count + ", start_num=" + start_num + ", end_num=" + end_num
				+ ", total_page_count=" + total_page_count + ", start_page=" + start_page + ", end_page=" + end_page
