...
public class SongVO implements Serializable{
	...
	public String toString() {
		return "SongVO [song_no=" + song_no + ", song_key=" + song_key + ", play_time=" + play_time + ", artist_key="
				+ artist_key + ", song_name=" + song_name + ", album_key=" + album_key + ", artist_name=" + artist_name
				+ ", issue_date=" + issue_date + ", is_title_song=" + is_title_song + ", is_hit_song=" + is_hit_song
				+ ", is_adult=" + is_adult + ", is_free=" + is_free + ", composition=" + composition + ", lyricist="
				+ lyricist + ", album_name=" + album_name + ", album_img=" + album_img + "]";
	}
